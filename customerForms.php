...
<body class="animsition">
    ...
    <!-- Title page -->
    <section class="bg-img1 txt-center p-lr-15 p-tb-92" style="background-image: url('images/back.jpg');">
            ...
            <div class="flex-w flex-tr">
                ...
                <div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
                    <form action="handler/customerregister.php" method="POST">
                        ...
                        <div class="bor8 m-b-30">
                            <input class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="password" name="password2" placeholder="repeat password">
                        </div>
